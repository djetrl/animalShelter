              ...
              <div className="container">
                  ...
                  <div className="main-sponsors__content">
                      <div className="main-sponsors__item">
                          ...
                          Наши главные помощники и спонсоры играют ключевую роль в поддержании нашего Приюта для животных. Благодаря их щедрой поддержке мы можем обеспечивать комфортные условия для наших питомцев и предоставлять им необходимый уход.

                          </p>
                      </div>
                      <div className="main-sponsors__item">
                          <img src={imgSponsors2} alt="" className="main-sponsors__img"/>
                          <p className="main-sponsors__text">Мы выражаем огромную благодарность нашим постоянным спонсорам, чья финансовая поддержка позволяет нам продолжать наше важное дело по защите и уходу за бездомными животными. Их добрые сердца делают нашу миссию возможной.</p>
                      </div>
                      <div className="main-sponsors__item">
                          <img src={imgPartners1} alt="" className="main-sponsors__img"/>
                          <p className="main-sponsors__text">Нашим главным помощникам мы обязаны не только материальной помощью, но и ценными советами, партнерством и поддержкой в организации мероприятий. Вместе мы создаем безопасное и заботливое окружение для всех наших питомцев.</p>
                      </div>
                      <div className="main-sponsors__item">
                          <img src={imgPartners2} alt="" className="main-sponsors__img"/>
                          <p className="main-sponsors__text">
                          Благодаря нашим преданным спонсорам и партнерам мы можем продолжать наше благородное дело по спасению и уходу за животными, которые нуждаются в нашей помощи. Их поддержка — наша сила и вдохновение для дальнейших усилий.
                          </p>
                      </div>
                  </div>
              </div>
